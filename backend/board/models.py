...
class Advert(models.Model):
    ...
    exp_filter = models.ForeignKey(ExpirationFilter, verbose_name="ExpFilter", on_delete=models.CASCADE)
    image = models.ForeignKey('gallery.Gallery', verbose_name="Image", blank=True, null=True, on_delete=models.SET_NULL)
    subject = models.CharField(max_length=255)
    description = models.TextField(max_length=1000)
    file = models.FileField(upload_to="callboard_file/", blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
        self.slug = transliteration_rus_eng(self.subject) + "-" + str(self.user.id)
